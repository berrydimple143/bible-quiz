...
return [
    ...
    'services' => [
        'polly' => [
             ...
             */
            'voice_id' => env('AWS_VOICE_ID', 'Nicole'),

            /**
             * IAM Credentials from AWS.
             */
            'credentials' => [
                'key'     => env('AWS_ACCESS_KEY_ID', 'AKIASLCKKZUBO22SA3ED'),
                'secret'  => env('AWS_SECRET_ACCESS_KEY', '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'),
            ],
