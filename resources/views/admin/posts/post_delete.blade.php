        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This post will be deleted permanently.</h4>
                    <p>Are you sure you want to delete this post with a title "{{ $model->title }}" and all of its comments?</p><br/>
                    {!! Form::open(['route' => ['post.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
