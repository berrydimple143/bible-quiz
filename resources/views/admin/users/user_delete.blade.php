        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This user will be deleted permanently.</h4>
                    <p>Are you sure you want to delete the account of "{{ $model->firstname }}"?</p><br/>
                    {!! Form::open(['route' => ['user.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
