        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This topic will be deleted permanently.</h4>
                    <p>Are you sure you want to delete "{{ $model->title }}"?</p><br/>
                    {!! Form::open(['route' => ['topic.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
