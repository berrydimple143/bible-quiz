        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This photo will be deleted permanently.</h4>
                    <p>Are you sure you want to delete this photo with a caption "{{ $model->title }}"?</p><br/>
                    {!! Form::open(['route' => ['photo.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
