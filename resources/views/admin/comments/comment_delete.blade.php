        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This comment will be deleted permanently.</h4>
                    <p>Are you sure you want to delete the comment of "{{ $model->name }}"?</p><br/>
                    {!! Form::open(['route' => ['comment.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
