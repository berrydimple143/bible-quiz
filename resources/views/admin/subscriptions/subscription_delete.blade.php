        ...
        <div class="card">
            ...
            <div class="body">
                <div class="alert bg-pink" role="alert">
                    <h4 class="alert-heading">Warning! This subscription will be deleted permanently.</h4>
                    <p>Are you sure you want to delete this subscription with a name "{{ $model->name }}"?</p><br/>
                    {!! Form::open(['route' => ['subscription.destroy', $model->id], 'method' => 'post']) !!}
                        {{ method_field('DELETE') }}
